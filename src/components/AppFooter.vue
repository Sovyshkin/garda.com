...
const messengers = ref([
  ...
  },
  {
    image: "tt_footer",
    name: "@garda.wallet",
    href: "https://www.tiktok.com/@garda.wallet?_t=ZS-90JyDE2j6uX&_r=1",
  },
]);
    ...
    <div class="top">
      <div class="wrap-logo">
        ...
        <span
          ...
          109456, Russian Federation, Moscow <br />
          Ryazansky Municipal District <br />
          4th Veshnyakovsky Proезд, Building 8, Structure 2</span
        >
      </div>
      ...
      <div class="footer-item">
        ...
        <nav>
          <li
            class="nav-item"
            @click="scrollToBottom(company.id)"
      ...
      <div class="footer-item">
        ...
        <nav>
          ...
          >
            <img
              :src="`/assets/${messenger.image}.svg`"
              :alt="messenger.image"
            />
